			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input
			    		...
			    		value="<?=(isset($_POST[$field['id'].'_x_'.$lng]) ? $_POST[$field['id'].'_x_'.$lng] : $_record[$lng][$field['db_name'].'_x'])?>"
			    		class="form-control"
				...
				<div class="col-sm-2">
					<input
			    		...
			    		value="<?=(isset($_POST[$field['id'].'_y_'.$lng]) ? $_POST[$field['id'].'_y_'.$lng] : $_record[$lng][$field['db_name'].'_y'])?>"
			    		class="form-control"
				...
				<div class="col-sm-2">
					<input
			    		...
			    		value="<?=(isset($_POST[$field['id'].'_z_'.$lng]) ? $_POST[$field['id'].'_z_'.$lng] : $_record[$lng][$field['db_name'].'_z'])?>"
			    		class="form-control"
			    		placeholder="ex: 12"
