					...
					<? for($j=1; $j<=count($images[$lng]); $j++){?>
						...
						<li data-id="<?=$images[$lng][$j]['id']?>" style="height:350px;">
							...
							<div class="text-left">
								...
								<input type="text" class="form-control" id="copyright_<?=$lng?>_<?=$images[$lng][$j]['id']?>" name="copyright_<?=$lng?>_<?=$images[$lng][$j]['id']?>" value="<?=$_POST['copyright_'.$lng.'_'.$images[$lng][$j]['id']]?>">
								<label for="title_<?=$lng?>_<?=$images[$lng][$j]['id']?>" class="control-label">Titlu</label>
								<input type="text" class="form-control" id="title_<?=$lng?>_<?=$images[$lng][$j]['id']?>" name="title_<?=$lng?>_<?=$images[$lng][$j]['id']?>" value="<?=$_POST['title_'.$lng.'_'.$images[$lng][$j]['id']]?>">
							</div>
						</li>
					<? }?>
				</ul>
