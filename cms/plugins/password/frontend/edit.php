	...
	<div id="field_<?=$field_id.'_'.$lng?>"
		...
		<div class="col-md-6 col-lg-5">
			<input
	    		...
	    		placeholder="<?=($field['placeholder']!="" ? $field['placeholder'] : "ex: Tnw84fgi4ec")?>"
	    		<? if($field['size'] != ""){?>
		    ...
		    <? if($field['do_not_edit']){?>
		    	<span class="help-block"><?=_lng('pass_cannot_change')?></span>
		    <? }else{?>
		    	<span class="help-block"><?=_lng('fill_only_change_pass')?></span>
		    <? }?>
		</div>
