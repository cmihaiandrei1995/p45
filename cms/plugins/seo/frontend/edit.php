            ...
            <div class="form-group lng_<?=$lng?>" <? if($i>1){?> style="display:none;"<? }?>>
                ...
                <div class="col-md-6 col-lg-5">
                    <input
                        ...
                        id="seo_title_<?=$lng?>"
                        name="seo_title_<?=$lng?>"
                        value="<?=(isset($_POST['seo_title_'.$lng]) ? $_POST['seo_title_'.$lng] : htmlentities($_record[$lng]['seo_title']))?>"
                        class="form-control"
            ...
            <div class="form-group lng_<?=$lng?>" <? if($i>1){?> style="display:none;"<? }?>>
                ...
                <div class="col-md-6 col-lg-5">
                    <input
                        ...
                        value="<?=(isset($_POST['seo_keywords_'.$lng]) ? $_POST['seo_keywords_'.$lng] : htmlentities($_record[$lng]['seo_keywords']))?>"
                        class="form-control"
            ...
            <div class="form-group lng_<?=$lng?>" <? if($i>1){?> style="display:none;"<? }?>>
                ...
                <div class="col-md-6 col-lg-5">
                    <input
                        ...
                        value="<?=(isset($_POST['seo_description_'.$lng]) ? $_POST['seo_description_'.$lng] : htmlentities($_record[$lng]['seo_description']))?>"
                        class="form-control"
                        placeholder="ex: Lorem ipsum dolor sit amet"
