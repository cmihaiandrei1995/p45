        ...
        <div class="row">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 hr-title">
                        <h3 class="oferte__title text--blue hr-title__text"><?= $_text_box_offer[$id]['section_title']; ?></h3>

                        <div class="row">
                            <div class="col-xs-12 col-lg-8 col-lg-offset-2">
                                <h4 class="hr-subtitle">
                                    <?= $_text_box_offer[$id]['description']; ?>
                                </h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="puzzle-masonry-col4">
                    <div class="row">
                        ...
                        <?php if ($_box_offer[$id]) { ?>
                            <!-- Loop through and count iterations -->
                            <?php $i = 0;
                            foreach ($_box_offer[$id] as $k_box => $item) { ?>
                                <!-- Tall one -->
                                <?php if ($i == 0) { ?>
                                            ...
                                            <a class="chartere__item__link oneitemlink" href="<?= $item['url']; ?>">
                                                ...
                                                <div class="oneitemlink-content">
                                                    <div class="chartere__item__procent__wrapper">
                                                        ...
                                                        <span class="chartere__item__procent__text">persoana</span>
                                                    </div>
            ...
            <?php } else { ?>
                <?php if ($i == 3) { ?>
                    ...
                    <?php if ($i == count($_box_offer[$id]) - 1) { ?>
                    </div>
                <?php } ?>
            <?php } ?>
