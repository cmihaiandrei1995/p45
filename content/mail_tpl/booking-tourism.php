                          ...
                          <table width="650" cellpadding="0" cellspacing="0" border="0" align="center" style="min-width:650px; line-height:28px;" class="devicewidth">
                              <tr>
                                  <td style="padding:10px 20px;">
                                    ...
                                    <!--
                                        <br>
                                        <i style="font-size:14px; color:#808080;">check in dupa 16:00</i>
                                    -->
                                  </td>
                  ...
                  <tbody>
                      ...
                      <? if($content['old_price'] > 0){?>
                          <tr>
                                ...
                                <? }else{ ?>
                                    <td style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right"><?=$content['old_price_ron']?> Ron</td>
                                <? }?>
                          </tr>
                          <tr>
                                ...
                                <? }else{ ?>
                                    <td style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right">- <?=($content['old_price_ron'] - $content['final_price_ron'])?> Ron</td>
                                <? }?>
                          </tr>
                      <? }else{ ?>
                          <tr>
                                ...
                                <? }else{ ?>
                                    <td style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right"><?=$content['final_price_ron']?> Ron</td>
                                <? }?>
                          </tr>
                      <? }?>
                      <!--
                      ...
                      <? if($content['discount_price'] > 0){?>
                          <tr>
                                ...
                                <? }else{ ?>
                                    <td style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right">- <?=$content['discount_price_ron']?> Ron</td>
                                <? }?>
                          </tr>
                      <? }?>
                      <tr>
                          ...
                          <? }else{ ?>
                              <td bgcolor="#f0f0f6" align="right" style="color:#818080; padding:10px 20px; border:1px solid #cacae3; border-left:0; color:#000000;">Total&nbsp;&nbsp;&nbsp;<b><?=$content['final_price_ron']-$content['discount_price_ron']?> Ron</b></td>
                          <? }?>
                      </tr>
                      <? if($content['form_data']['pay_amount'] != "full"){?>
                          <tr>
                                ...
                                <? }else{ ?>
                                    <td style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right"><?=$content['advance_price_ron']-$content['discount_advance_price_ron']?> Ron</td>
                                <? }?>
                          </tr>
                      <? }?>
                      <tr><td height="35"></td></tr>
