                        ...
                        <table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:660px;">
                                    ...
                                    <table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:660px;">
                                        <tr>
                                            <td align="center" valign="top" style="font-size:0;">
                                                ...
                                                <![endif]-->
                                                <div style="display:inline-block; max-width:85px; min-width:85px; vertical-align:top;" class="stack-column test" id="test123">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            <div class="left-responsive">
                                                                                <img width="57" border="0" height="40" alt="" style="display:inline-block; border:none; outline:none; text-decoration:none;" src="<?=$_base?>static/img/vote/logo.png">
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                ...
                                                <![endif]-->
                                                <div style="display:inline-block; max-width:315px; min-width:315px; vertical-align:top;" class="stack-column">
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        <tr>
                                                            <td>
                                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="text-align: left;">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            <div class="left-responsive">
                                                                                <img width="315" border="0" height="91" alt="" style="display:inline-block; border:none; outline:none; text-decoration:none;" src="<?=$_base?>static/img/vote/voteaza.jpg">
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                ...
                                                <![endif]-->
                                                <div style="display:inline-block; max-width:230px; min-width:230px; vertical-align:top;" class="stack-column">
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        <tr>
                                                            <td>
                                                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="text-align: left;">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <div class="left-responsive">
                                                                                <img width="230" border="0" height="125" alt="" style="display:inline-block; border:none; outline:none; text-decoration:none;" src="<?=$_base?>static/img/vote/grafica.jpg">
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                            ...
                            <tr>
                                ...
                                <td align="center" valign="middle" height="40" style="font-family: Tahoma, Geneva, sans-serif; color:#2f62a2;line-height:22px!important; font-weight: normal;text-align: center;mso-line-height-rule: exactly; padding:0 30px;">
                                    ...
                                    <p style="font-size:16px !important; font-weight:bold;line-height:22px!important; maegin:0;">
                                        <span style="text-transform:uppercase;">FelicitĂri !</span><br>
                                        Te-ai inscris în concurs!
                                    </p>
                                    <br>
                                    <p style="line-height:22px!important;font-size: 14px!important;">
                                        Pe 27 mai verifică pagina noastră de facebook <a href="https://www.facebook.com/Paralela45/" target="_blank" style="color:#2f62a2; font-size: 14px!important;"><img width="16" border="0" height="22" alt="" style="display:inline-block; border:none; outline:none; text-decoration:none; margin-left:10px;" src="<?=$_base?>static/img/vote/fb.jpg"> facebook.com/Paralela45/</a> ca să vezi dacă ai câștigat. Până atunci poți să ne dai un like <a href="https://www.facebook.com/Paralela45/" target="_blank" style="color:#2f62a2; font-size: 14px!important;"><img width="21" border="0" height="22" alt="" style="display:inline-block; border:none; outline:none; text-decoration:none;" src="<?=$_base?>static/img/vote/like.jpg"></a>
                                        <br>
                                        <br>
                                        <br>
                                        <strong>Nu uita să mergi la VOT!</strong>
                                    </p>
                        		</td>
