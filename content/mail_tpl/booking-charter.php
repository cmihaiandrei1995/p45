               ...
               <table width="650" cellpadding="0" cellspacing="0" border="0" align="center" style="min-width:650px;" class="devicewidth">
                  <tbody>
                      ...
                      <tr><td style="color:#000; font-size:16px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:24px;">
      					<b style="font-size:24px;">Rezervarea ta</b><br><br>

      					Salut,<br><br>

      					Esti la un pas distanta de vacanta mult dorita.<br>
      					Te asteapta <b>#experientedeneuitat</b> in <b><?=$content['zone']?></b>.<br>
         ...
         <tr>
            <td align="center" style="color:#000; font-size:16px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:24px;">
               <table width="650" cellpadding="0" cellspacing="0" border="0" align="center" style="min-width:650px;" class="devicewidth">
                    <tbody>
                        <tr>
          					...
          					<td style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right">
                                <?
                                for($i=0; $i<$content['search_data']['rooms']; $i++){
                        			foreach(array('adult', 'child') as $type){
                        				if($content['search_data']['rooms_info'][$i][$type] > 0) {
                        					for($j=0; $j<$content['search_data']['rooms_info'][$i][$type]; $j++){
                                                echo $content['form_data'][$type.'_name_'.$i.'_'.$j]." ".$content['form_data'][$type.'_surname_'.$i.'_'.$j]." (".date("d.m.Y", strtotime($content['form_data'][$type.'_dob_'.$i.'_'.$j])).")<br>";
                                            }
                                        }
                                    }
                                }
                      ...
                      <tr>
                        <td align="left" style="color:#818080; padding:10px 20px; padding-right: 0; border:1px solid #cacae3; border-right:0;">Cazare</td>
                    ...
                    <tr>
                      <td align="left" style="color:#818080; padding:10px 20px; padding-right: 0; border:1px solid #cacae3; border-right:0;">Tip camera</td>
                      <td style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right"><?=$content['room_info']?></td>
                    </tr>
                    <tr>
                      <td align="left" bgcolor="#f0f0f6" style="color:#818080; padding:10px 20px; padding-right: 0; border:1px solid #cacae3; border-right:0;">Masa</td>
                      <td bgcolor="#f0f0f6" style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right"><?=$content['meal_info'] != "" ? $content['meal_info'] : "Conform program" ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td align="left" bgcolor="#f0f0f6" style="color:#818080; padding:10px 20px; padding-right: 0; border:1px solid #cacae3; border-right:0;">Disponibilitate</td>
                      <td bgcolor="#f0f0f6" style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right"><?=$content['availability'] == "IM" ? "Disponibil" : "La cerere" ?></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <br><br>
                            <p style="color:#293245;">
                                <? if($content['availability'] == "IM"){?>
                                ...
                                <? }else{?>
                                    <b>Pachetul ales este disponibil la cerere</b>. Acesta poate fi confirmat sau nu de partenerii nostri. In cazul platii cu cardul, banii vor fi incasati doar dupa confirmarea sejurului. In caz contrar, ei vor fi deblocati in cel mai scurt timp. In cazul platii prin OP sau in agentie, rezervarea va fi confirmata dupa plata integrala sau a avansului, dupa caz. Plata prin OP se efectueaza doar dupa confirmarea finala a agentului.
                                <? }?>
                            </p>
                        </td>
                    </tr>
...
<div class="block">
   <table width="100%" cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
      <tbody>
         <tr>
            <td align="center" style="color:#293245; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:24px;">
               <table width="650" cellpadding="0" cellspacing="0" border="0" align="center" style="min-width:650px;" class="devicewidth">
                  <tbody>
                      <tr><td height="35"></td></tr>
                      <tr><td style="color:#000; font-size:24px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:24px; font-weight:bold;">Locatie</td></tr>
                      <tr><td height="35"></td></tr>
                      <tr>
      					<td style="color:#293245; font-size:18px; padding:10px 20px; border:1px solid #cacae3; border-bottom:0;">
                            <b><?=$content['item']['title']?></b>
                            <? if($content['item']['stars']){?>
                                <? for($i=1; $i<=$content['item']['stars']; $i++){?>
                                    <img width="11" border="0" height="12" style="display:inline-block; border:none; outline:none;" src="<?=$_base?>static/img/nl/star.png">
                                <? }?>
                            <? }?>
                            <br>
                            <span style="font-size:16px; color:#808080;"><img width="10" border="0" height="14" style="display:inline-block; border:none; outline:none;" src="<?=$_base?>static/img/nl/pin.png"> <?=$content['city']?></a>
                        </td>
                      </tr>
                      <tr>
      					<td style="border:1px solid #cacae3;">
                            <img width="650" border="0" alt="" style="display:block; border:none; outline:none;" src="<?=$content['item']['images'][0]['big']?>" class="bigimage">
                        </td>
                      </tr>
                      <tr><td style="color:#293245; font-size:16px; border:1px solid #cacae3; border-top:0;">
                          <table width="650" cellpadding="0" cellspacing="0" border="0" align="center" style="min-width:650px; line-height:28px;" class="devicewidth">
                              <tr>
                                  <td style="padding:10px 20px;">
                                    <b>Dus</b><br>
                                    <?=date("d.m.Y", strtotime($content['check_in']))?>
                                    <br>
                                    <i style="font-size:14px; color:#808080;">
                                        <?=date("d.m.Y", strtotime($content['flight_info'][0]['from_date']))?> - <?=ucwords(strtolower($content['flight_info'][0]['company']))?><br>
                                        <?=date("H:i", strtotime($content['flight_info'][0]['from_date']))?> <?=$content['flight_info'][0]['from']?> -
                                        <?=date("H:i", strtotime($content['flight_info'][0]['to_date']))?> <?=$content['flight_info'][0]['to']?>
                                    </i>
                                  </td>
                                  <td style="padding:10px 20px;"><img width="15" border="0" height="14" alt="" style="display:block; border:none; outline:none;" src="<?=$_base?>static/img/nl/arr.jpg"></td>
                                  <td style="padding:10px 20px;">
                                      <b>Intors</b><br>
                                      <?=date("d.m.Y", strtotime($content['check_out']))?>
                                      <br>
                                      <i style="font-size:14px; color:#808080;">
                                          <?=date("d.m.Y", strtotime($content['flight_info'][1]['from_date']))?> - <?=ucwords(strtolower($content['flight_info'][1]['company']))?><br>
                                          <?=date("H:i", strtotime($content['flight_info'][1]['from_date']))?> <?=$content['flight_info'][1]['from']?> -
                                          <?=date("H:i", strtotime($content['flight_info'][1]['to_date']))?> <?=$content['flight_info'][1]['to']?>
                                      </i>
                                  </td>
                              </tr>
                          </table>
                      ...
                      <tr><td style="font-size:12px; font-style: italic; line-height:18px;">Orarul de zbor are caracter informativ si poate suferi modificari independente de vointa noastra. Veti fi informati din timp de un consulant cu privire la eventualele modificari.</td></tr>
                      <tr><td height="35"></td></tr>
                  </tbody>
               </table>
            </td>
      ...
      <tbody>
         <tr>
            <td align="center" style="color:#000; font-size:16px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:24px;">
               <table width="650" cellpadding="0" cellspacing="0" border="0" align="center" style="min-width:650px;" class="devicewidth">
                  <tbody>
                      <tr><td colspan="2" style="color:#000; font-size:24px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:24px; font-weight:bold;">Date facturare</td></tr>
                      <tr><td height="35"></td></tr>
                      <tr>
            ...
            <td align="center" style="color:#000; font-size:16px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:24px;">
               <table width="650" cellpadding="0" cellspacing="0" border="0" align="center" style="min-width:650px;" class="devicewidth">
                  <tbody>
                      ...
                      <tr><td height="35"></td></tr>
                      <? if($content['show_storno_insurance']){?>
                          <tr>
              					<td align="left" style="color:#818080; padding:10px 20px; padding-right: 0; border:1px solid #cacae3; border-right:0;">Asigurare STORNO</td>
              					<td style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right"><b>GRATUIT</b></td>
                          </tr>
                      <? }?>
                      <? if($content['old_price'] > 0){?>
                          <tr>
              					...
              					<td style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right"><?=$content['old_price']?> € (<?=$content['old_price_ron']?> Ron)</td>
                          </tr>
                          <tr>
              					<td align="left" style="color:#818080; padding:10px 20px; padding-right: 0; border:1px solid #cacae3; border-right:0;">Reducere</td>
              					<td style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right">- <?=($content['old_price'] - $content['final_price'])?> € (<?=($content['old_price_ron'] - $content['final_price_ron'])?> Ron)</td>
                          </tr>
                      <? }else{ ?>
                          <tr>
              					<td align="left" style="color:#818080; padding:10px 20px; padding-right: 0; border:1px solid #cacae3; border-right:0;">Pret integral</td>
                      ...
                      <? if($content['discount_price'] > 0){?>
                          <tr>
              					<td align="left" style="color:#818080; padding:10px 20px; padding-right: 0; border:1px solid #cacae3; border-right:0;">Reducere promo</td>
              					<td style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right">- <?=$content['discount_price']?> € (<?=$content['discount_price_ron']?> Ron)</td>
                          </tr>
                      <? }?>
                      <tr>
                          <td bgcolor="#f0f0f6" style="color:#818080; padding:10px 20px; padding-right: 0; border:1px solid #cacae3; border-right:0;"></td>
          				  <td bgcolor="#f0f0f6" align="right" style="color:#818080; padding:10px 20px; border:1px solid #cacae3; border-left:0; color:#000000;">Total&nbsp;&nbsp;&nbsp;<b><?=$content['final_price']-$content['discount_price']?> € (<?=$content['final_price_ron']-$content['discount_price_ron']?> Ron)</b></td>
                      </tr>
                      <? if($content['form_data']['pay_amount'] != "full"){?>
                          <tr>
                                ...
                                <td style="padding:10px 20px; padding-left: 0; border:1px solid #cacae3; border-left:0; line-height:24px;" align="right"><?=$content['advance_price']-$content['discount_advance_price']?> € (<?=$content['advance_price_ron']-$content['discount_advance_price_ron']?> Ron)</td>
                          </tr>
                      <? }?>
                      <tr><td height="35"></td></tr>
                  </tbody>
               ...
               <table width="650" cellpadding="0" cellspacing="0" border="0" align="center" style="min-width:650px;" class="devicewidth">
                  <tbody>
                    <tr><td align="left" style="color:#808080; font-size:16px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:24px;">
      					<p style="color:#293245; font-weight:bold;">Servicii incluse</p>
                        <ul style="list-style:none; padding-left:0;">
                            <li><img src="<?=$_base?>static/img/nl/list.jpg" border="0" style="display:inline-block; border:none; outline:none;" width="12" height="10"> Bilet de avion dus/intors</li>
                            <li><img src="<?=$_base?>static/img/nl/list.jpg" border="0" style="display:inline-block; border:none; outline:none;" width="12" height="10"> Taxe de aeroport</li>
                            <li><img src="<?=$_base?>static/img/nl/list.jpg" border="0" style="display:inline-block; border:none; outline:none;" width="12" height="10"> Transfer aeroport - hotel - aeroport</li>
                            <li><img src="<?=$_base?>static/img/nl/list.jpg" border="0" style="display:inline-block; border:none; outline:none;" width="12" height="10"> Cazare <?=$content['nr_nights']?> nopti</li>
                            <li><img src="<?=$_base?>static/img/nl/list.jpg" border="0" style="display:inline-block; border:none; outline:none;" width="12" height="10"> Masa conform ofertei alese</li>
                            <li><img src="<?=$_base?>static/img/nl/list.jpg" border="0" style="display:inline-block; border:none; outline:none;" width="12" height="10"> Asistenta turistica</li>
                        </ul>
      				</td></tr>
                    <tr><td height="35"></td></tr>
                    <tr><td align="left" style="color:#808080; font-size:16px; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; line-height:24px;">
      					<p style="color:#293245; font-weight:bold;">Pachetul nu include</p>
                        <ul style="list-style:none; padding-left:0;">
                            <li>Asigurarea de calatorie, Asigurarea storno, Excursiile optionale, Alte servicii neincluse in pachet</li>
                        </ul>
                        <p>
